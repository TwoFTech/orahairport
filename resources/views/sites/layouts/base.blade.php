...
<html lang="fr">
    <head>
        ...
        <link href="{{ asset((!\App::environment('local') ? 'public/' : '') . 'storage/css/style.css?v=20') }}" rel="stylesheet" type="text/css">

        <link href="{{ asset((!\App::environment('local') ? 'public/' : '') . 'storage/css/custom.css?v=20') }}" rel="stylesheet" type="text/css">
